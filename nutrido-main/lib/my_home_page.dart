...
import 'package:nutrido/screens/ask_AI_page.dart';
import 'package:nutrido/widgets/ask_ai_widget.dart';
import 'package:nutrido/widgets/custom_app_bar_widget.dart';
import 'package:nutrido/widgets/food_item_card_shimmer.dart';
import 'package:nutrido/widgets/nutrient_info_shimmer.dart';
import 'package:nutrido/widgets/total_nutrients_card_shimmer.dart';
import 'package:nutrido/widgets/date_selector.dart';
import 'package:nutrido/widgets/detailed_nutrients_card.dart';
import 'package:nutrido/widgets/food_history_card.dart';
import 'package:nutrido/widgets/food_item_card.dart';
import 'package:nutrido/widgets/header_widget.dart';
import 'package:nutrido/widgets/macronutrien_summary_card.dart';
import 'package:nutrido/widgets/nutrient_balance_card.dart';
import 'package:nutrido/widgets/nutrient_tile.dart';
import 'package:nutrido/data/nutrient_insights.dart';
import 'package:nutrido/widgets/total_nutrients_card.dart';
...
class _MyHomePageState extends State<MyHomePage> {
      ...
      children: [
        ElevatedButton.icon(
          ...
          style: ElevatedButton.styleFrom(
            ...
            backgroundColor: const Color(0xFFACC8A2), // Mint green from splash screen
            ...
            actions: [
              TextButton(
                ...
                style: TextButton.styleFrom(
                  foregroundColor: const Color(0xFFACC8A2), // Mint green from splash screen
                ),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: CustomAppBar(
        title: ['Scan Label', 'Scan Food', 'Daily Intake'][_currentIndex],
      ),
        ...
        child: ClipRect(
          child: BackdropFilter(
            ...
            child: BottomNavigationBar(
              ...
              backgroundColor: Colors.transparent,
              selectedItemColor: const Color(0xFFACC8A2), // Mint green from splash screen
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        color: const Color.fromARGB(
                            255, 94, 255, 82), // Green accent bar
                        borderRadius: BorderRadius.circular(2),
                      ),
                    ),
                    const SizedBox(width: 12),
                    ...
                    if (_logic.getServingSize() > 0)
                      Padding(
                        ...
                        child: Slider(
                            ...
                            activeColor: const Color(0xFFACC8A2), // Mint green from splash screen
                            onChanged: (newValue) {
